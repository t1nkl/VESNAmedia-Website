$(document).ready(function() {
  ...
  $(function() {      
    var slider = $('.slider'),
      ...
      slideWidth = /*$('.slider-wrap').width()*/1320,         // Ширина слайдера
    ...
    var  bullets = $('.slider-wrap .bullets li')          // Переменная хранит набор буллитов
   
   
    $('.slider-wrap .bullets li:first').addClass('active');  
